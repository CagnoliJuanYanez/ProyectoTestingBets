...
public class AdminGUI extends JFrame {
	...
	private static final String LABEL_BUNDLE = "Etiquetas";
	...
	private void initialize() {
		...
		this.setTitle(ResourceBundle.getBundle(LABEL_BUNDLE).getString("AdminTitle"));
	}
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			JButton jButtonGertaerakEzabatu = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("GertaerakEzabatu")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private JButton getBoton2() {
		if (jButtonCreateQuery == null) {
			...
			jButtonCreateQuery.setText(ResourceBundle.getBundle(LABEL_BUNDLE).getString("CreateQuery"));
	...
	private JButton getBoton3() {
		if (jButtonQueryQueries == null) {
			...
			jButtonQueryQueries.setText(ResourceBundle.getBundle(LABEL_BUNDLE).getString("QueryQueries"));
	...
	private JLabel getLblNewLabel() {
		if (jLabelSelectOption == null) {
			jLabelSelectOption = new JLabel(ResourceBundle.getBundle(LABEL_BUNDLE).getString("SelectOption"));
	...
	private JButton getBtnNewButton() {
		if (btnNewButton == null) {
			btnNewButton = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("KuotakIpini")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private JButton getBtnNewButton_1() {
		if (btnNewButton_1 == null) {
			btnNewButton_1 = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("GertaerakSortu")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private JButton getJButtonEmaitzaIpini() {
		if (jButtonEmaitzaIpini == null) {
			jButtonEmaitzaIpini = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("EmaitzaIpini"));
	...
	private JButton getJButtonDesLogin() {
		if (jButtonDesLogin == null) {
			jButtonDesLogin = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("DesLogin")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private JButton getBtnNewButton_2() {
		if (btnNewButton_2 == null) {
			btnNewButton_2 = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("Mezuak")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private JButton getBtnGertaerakKopiatu() {
		if (btnGertaerakKopiatu == null) {
			btnGertaerakKopiatu = new JButton(ResourceBundle.getBundle(LABEL_BUNDLE).getString("GertaerakKopiatu")); //$NON-NLS-1$ //$NON-NLS-2$
